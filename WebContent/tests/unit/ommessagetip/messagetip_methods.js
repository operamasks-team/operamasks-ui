(function($){
	...
	test( "content", function() {
		...
		content = element.find('div.om-messageTip-content-body').html();
        //fix http://jira.apusic.net/browse/AOM-403
        // first if for FireFox、Chrome。second is for IE9、third is for IE6/IE7/IE8、last one is not used
        var result= (content=='<font size="24px" color="red">高级</font>自定义内容' || content=='<font color="red" size="24px">高级</font>自定义内容' || content=='<FONT color=red size=24>高级</FONT>自定义内容' || content=='<FONT size=24 color=red>高级</FONT>自定义内容');
